...
Reducing the simulation’s repetitions from 1000 to 100 revealed notable changes in result consistency across runs:

Observations:

- Less Smooth Histograms: The histograms appeared more irregular, with gaps and spikes, unlike the smoother distribution from 1000 repetitions.
...
Conclusion on Reproducibility: With fewer repetitions, results were less reproducible due to greater random variation. While the general tracing bias trend was present, specific values varied between runs. Larger sample sizes, like 1000, are more reliable for stable results, reducing the influence of random variation.
